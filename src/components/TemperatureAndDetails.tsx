...
function TemperatureAndDetails({ weather: { details, icon, temp, temp_max, temp_min, sunrise, sunset, speed, humidity, feels_like, timezone } }) {
   return (
      <div>
         ...
         <div className="flex flex-row justify-center items-center space-x-2 py-3 text-white text-sm">
